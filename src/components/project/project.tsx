...
const Project = ({id, name, nameCreator, arrSoc, favorit, onClick, onClickStar}: ProjectProps) => {
    ...
    return (
        <div onClick={onClick} data-name={name} data-id={id} className={styles.container}>
            <div className={styles.head}>
                ...
                <div onClick={onClickStar} data-id={id} data-name={name} className={favorit ? styles.head__star__active : styles.head__star}/>
            </div>
            <div className={styles.main}>
                <div className={styles.main__container}>
                    {arrSoc ? arrSoc.map((soc: string, i:number) => {
                        return <div className={styles.telega} key={i}/>
                    }) : <></>}
                </div>
