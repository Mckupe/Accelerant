...
function Authpage() {
  ...
  async function buttonClick(e: any) {
    ...
    } if (reEmail.test(userStore.userdata.email) && rePass.test(userStore.userdata.password)) {
      if (panel === 'auth') {
  ...
  return (
    <div className={styles.main__container}>
      <Authorization panel={panel} changePanel={changePanel} eye={eye} changeEye={changeEye} buttonClick={buttonClick}/>
    </div>
  );
}
